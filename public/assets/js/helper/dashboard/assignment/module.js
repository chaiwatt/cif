import * as Module from './module/module-api.js'
...
$(document).on('click', '#un_assignment_module_button', function() {
    ...
    var moduleJsonRoute = window.params.moduleJsonRoute;

    // Additional code logic here...
    Module.getModuleJson(groupId, roleId, moduleJsonRoute).then(response => {
        ...
        $(document).on('click', '#bntSaveModule', function (event) {
            ...
            var updateModuleJsonRoute = window.params.updateModuleJsonRoute;
            Module.updateModuleJson(groupId, roleId, updateModuleJsonRoute, updatedValues).then(response => {
