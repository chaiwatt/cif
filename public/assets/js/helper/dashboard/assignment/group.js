...
import * as Group from './group/group-api.js'
...
$(document).on('click', 'a[data-confirm]', function (event) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Group.deleteGroupInRole(deleteRoute).then(response => {
...
$(document).on('click', '#bntSaveGroup', function (event) {
    ...
    var storeGroupRoute = window.params.storeGroupRoute;
    Group.storeGroupToRole(selectedGroupIds, roleId, storeGroupRoute).then(response => {
