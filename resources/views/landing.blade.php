    ...
    <section class="d-flex flex-column align-items-center" style="gap: 80px; margin: 80px 0 ;">
        ...
        <div class="d-flex flex-column flex-lg-row" style="gap: 80px">
            <div class="text-center" style="width: 250px">
                ...
                <p class="m-0 fw-semibold">038-296-5368<br>038-111-6300</p>
            </div>
            <div class="text-center" style="width: 250px">
                <p class="text-muted mb-3">ที่อยู่</p>
                <p class="m-0 fw-semibold">83/5 หมู่ 10 ตำบลหนองขาม<br> อำเภอศรีราชา จังหวัดชลบุรี 20230</p>
            </div>
            <div class="text-center" style="width: 250px">
                <p class="text-muted mb-3">เวลาทำการ</p>
                <p class="m-0 fw-semibold">จันทร์-ศุกร์ เวลา 08:00-17:00,
                    <br>เสาร์ เวลา 08:00-17:00</p>
            </div>
        </div>
