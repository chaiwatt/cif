...
<body>
    ...
    <div class="a4-wrapper">
        <div class="header">
            ...
            <h3>รายงานจ่ายเงินเดือนงวดพิเศษ {{ \Carbon\Carbon::createFromFormat('Y-m-d',
        ...
        <div class="box" style="border:none">
            <span style="font-weight: bold">{{$companyDepartment->name}}</span>
            @php
            $totalExceedOvertimeCost = 0;
            $totalHolidayOvertimeCost = 0;
            $totalTraditionalHolidayOvertimeCost = 0;
            ...
            $traditionalHolidayOvertimeCost=$userSummary['traditionalHolidayOvertimeCost'];

            $totalExceedOvertimeCost += $exceedOvertimeCost;
            $totalHolidayOvertimeCost += $holidayOvertimeCost;
            $totalTraditionalHolidayOvertimeCost += $traditionalHolidayOvertimeCost;
            ...
            <div class="col12">
                ...
                <div class="col1" style="text-align: center">-</div>
                <div class="col1" style="text-align: center">{{ number_format(round($exceedOvertimeCost +
                    $traditionalHolidayOvertimeCost, 0),
                    2)}}</div>
                <div class="col1" style="text-align: center">{{ number_format(round($holidayOvertimeCost, 0),
                    2)}}</div>
                <div class="col1" style="text-align: center">-</div>
                <div class="col1" style="text-align: center">-</div>
                <div class="col1" style="text-align: center">-</div>
                <div class="col1" style="text-align: center">-</div>
                <div class="col1" style="text-align: right;float:rigth">{{
                    number_format(round($exceedOvertimeCost+$holidayOvertimeCost+$traditionalHolidayOvertimeCost, 0),
                    2)}}
                </div>
            </div>
            ...
            <div class="col12">
                ...
                <div class="col1" style="text-align: center;font-weight:bold">{{
                    number_format(round($totalExceedOvertimeCost + $totalTraditionalHolidayOvertimeCost, 0),
                    2)}}</div>
                <div class="col1" style="text-align: center;font-weight:bold">{{
                    number_format(round($totalHolidayOvertimeCost, 0),
                    2)}}</div>
                <div class="col1" style="text-align: center">-</div>
                <div class="col1" style="text-align: center">-</div>
                <div class="col1" style="text-align: center">-</div>
                <div class="col1" style="text-align: center">-</div>
                <div class="col1" style="font-weight:bold;text-align: right;float:rigth">{{
                    number_format(round($totalExceedOvertimeCost +
                    $totalHolidayOvertimeCost + $totalTraditionalHolidayOvertimeCost, 0),
                    2)}}</div>
