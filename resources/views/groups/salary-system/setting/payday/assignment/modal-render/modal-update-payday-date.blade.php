<div class="row">
    ...
    <div class="col-12">
        <div class="form-group">
            <label for="startDate">เริ่มวันที่ (วดป. คศ)<span class="small text-danger">*</span></label>
    ...
    <div class="col-12">
        <div class="form-group">
            <label for="paymentDate">วันที่จ่ายเงินเดือน (วดป. คศ)<span class="small text-danger">*</span></label>
