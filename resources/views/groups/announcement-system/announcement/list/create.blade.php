                        ...
                        <div class="row card-body">
                            <div class="col-12 col-lg-3">
                                <div class="form-group mb-2">
                                    ...
                                    <label for="announce-img-input" class="rounded-4 overflow-hidden d-flex flex-column" style="height: 308px;">
                                        {{-- style="width: 100%; height:100%; object-fit: cover;" --}}
                                        <div class="d-flex justify-content-center align-items-center" style="background: #667085; flex: 1">
                                            <img src="{{ asset('icon _Image_.png') }}" alt="announce-preview" id="announce-preview">
                                        </div>
                                        <div class="d-flex align-items-center justify-content-center" style="background: rgb(102, 112, 133, .5);height: 42px;">
                                            <p class="m-0 text-decoration-underline">เพิ่มรูปภาพ</p>
                                        </div>
                                    </label>
                                    <input type="file" name="announce-image" id="announce-img-input" hidden>
                                </div>
                            ...
                            <div class="col-12 col-lg-9">
                                ...
                                <div class="form-group">
                                    <label for="description">คำอธิบาย <span class="fw-bold text-danger">*</span></label>
                                ...
                                <div class="row gy-2 mt-2">
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <label for="start_date">วันเริ่มประกาศ <span class="fw-bold text-danger">*</span></label>
                                            <div class="date-box date" id="start_date" data-target-input="nearest">
                                                <input name="start_date" value="{{old('start_date')}}" type="text"
                                                    class="form-control datetimepicker-input @error('start_date') is-invalid @enderror" data-target="#start_date">
