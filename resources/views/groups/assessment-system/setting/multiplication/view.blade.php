            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form
                            action="{{route('groups.assessment-system.setting.multiplication.update',['id' => $assessmentScoreMultiplication->id])}}"
                            method="POST">
                            <div class="card-body">
                                @method('PUT')
                                @csrf
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="multiplication" id="multiplication"
                                                value="{{old('multiplication') ?? $assessmentScoreMultiplication->multiplication}}"
