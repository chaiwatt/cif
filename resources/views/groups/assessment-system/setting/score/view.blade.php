...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">คะแนนเกณฑ์การประเมิน</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a
                                href="{{route('groups.assessment-system.setting.score')}}">คะแนนเกณฑ์การประเมิน</a>
                        </li>
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">คะแนนเกณฑ์การประเมิน</h3>
                        ...
                        <div class="card-body">
                            <form
                                action="{{route('groups.assessment-system.setting.score.update',['id' => $assessmentScore->id])}}"
                                method="POST">
                                @method('PUT')
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>คะแนนเกณฑ์การประเมิน<span class="small text-danger">*</span></label>
