<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">แดชบอร์ดระบบเงินเดือน</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('home')}}">หน้าหลัก</a></li>
                    <li class="breadcrumb-item active">ระบบเงินเดือน</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">งวดปกติรายเดือน</span>
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">งวดปกติรายวัน</span>
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">งวดพิเศษรายวัน</span>
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">งวดพิเศษรายเดือน</span>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">งวดปกติรายเดือน</h3>
