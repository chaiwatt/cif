                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a
                                href="{{route('jobs.schedulework.schedule.assignment',['id' => $workSchedule->id])}}">ตารางทำงาน</a>
                        </li>
...
<script>
    $(function () {
        $('.select2').select2()
        window.params = {
            addCalendarRoute: '{{ route('jobs.schedulework.schedule.assignment.store-calendar') }}',
            url: '{{ url('/') }}',
