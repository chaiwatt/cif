                                                ...
                                                <tr>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li style="padding: 5px;">
                                                                {{$user->name}} {{$user->lastname}}<a
                                                                    ...
                                                                    href="{{ route('setting.assignment.role.delete', ['roleId' => $role->id, 'userId' =>$user->id])}}"><i
                                                                        class="fas fa-times"
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <a class="btn btn-primary btn-sm"
                                                            href="{{ route('setting.assignment.group.view', ['id' => $role->id]) }}">
...
@push('scripts')
<script type="module" src="{{asset('assets/js/helper/dashboard/assignment/role.js?v=1.1')}}"></script>
...
<script>
    ...
    window.params = {
        ...
        assignUserToRoleRoute: "{{ route('setting.assignment.role.store') }}",
        url: '{{ url('/') }}',
