...
<body class="d-flex flex-column" style="height: 100vh;">
        <nav class="main-header navbar navbar-expand-md bg-white" style="padding: 12px 0;">
            <div class="container-fluid px-3">
                <a href="{{route('home')}}" class="navbar-brand"><img src="{{ asset('CIF_Logo.png') }}" height="32" alt="website logo"></a>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvas" aria-labelledby="offcanvas-brand">
                    <div class="offcanvas-header">
                      <h5 class="offcanvas-title" id="offcanvas-brand"><img src="{{ asset('CIF_Logo.png') }}" height="32" alt="website logo"></h5>
