            ...
            <nav class="navbar navbar-expand">
                <ul class="navbar-nav d-flex justify-content-between align-items-center w-100 px-3">
                    ...
                    <li class="d-flex gap-3">
                        ...
                        {{-- โทรโขง --}}
                        <a href="{{ route('announcement') }}" class="btn rounded-circle d-flex align-items-center justify-content-center p-0" style="width: 40px; height: 40px;">
                        ...
                        {{-- document --}}
                        <a href="{{ route('application') }}" class="btn rounded-circle d-flex align-items-center justify-content-center p-0 noifiy" style="width: 40px; height: 40px;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        {{-- calender --}}
                        <a href="#" class="btn rounded-circle d-flex align-items-center justify-content-center p-0" style="width: 40px; height: 40px;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
